...
public class javalab_04 {
	...
	public static void main(String[] args) {
		...
		String hour_input = JOptionPane.showInputDialog(null, "Enter total hours for this employee.","Input",JOptionPane.QUESTION_MESSAGE);
		double hour = Double.parseDouble(hour_input);
		String wage_input = JOptionPane.showInputDialog(null, "Enter total wage for this employee.","Input",JOptionPane.QUESTION_MESSAGE);
		double wage = Double.parseDouble(wage_input);
